// Generated by SolidPython 1.1.3 on 2026-02-12 11:32:57


scale(v = 1) {
	translate(v = [0, 0, 0]) {
		union() {
			color(alpha = 1.0000000000, c = [0.5500000000, 0.5500000000, 0.7000000000]) {
				translate(v = [0, 0, -7.0000000000]) {
					linear_extrude(height = 5.0000000000) {
						polygon(points = [[-70000, -22500], [-70000, 22500], [70000, 22500], [70000, -22500]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.8500000000, 0.8500000000, 0.6000000000]) {
			...
			color(alpha = 1.0000000000, c = [0.5500000000, 0.5500000000, 0.7000000000]) {
				translate(v = [0, 0, 0.0000000000]) {
					linear_extrude(height = 0.2200000000) {
						polygon(points = [[-54500, -4250], [-54500, -3750], [-29500, -3750], [-29500, -4250]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.5500000000, 0.5500000000, 0.7000000000]) {
				translate(v = [0, 0, 0.0000000000]) {
					linear_extrude(height = 0.2200000000) {
						polygon(points = [[-6000, -6000], [-6000, -250], [-12500, -250], [-12500, 250], [-6000, 250], [-6000, 6000], [6000, 6000], [6000, 250], [12500, 250], [12500, -250], [6000, -250], [6000, -6000]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.5500000000, 0.5500000000, 0.7000000000]) {
				translate(v = [0, 0, 0.0000000000]) {
					linear_extrude(height = 0.2200000000) {
						polygon(points = [[-54500, 5750], [-54500, 6250], [-29500, 6250], [-29500, 5750]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.5500000000, 0.5500000000, 0.7000000000]) {
				translate(v = [0, 0, 0.0000000000]) {
					linear_extrude(height = 0.1500000000) {
						polygon(points = [[-10000, -2500], [-10000, 2500], [10000, 2500], [10000, -2500]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.5500000000, 0.5500000000, 0.7000000000]) {
				translate(v = [0, 0, 0.0000000000]) {
					linear_extrude(height = 0.1500000000) {
						polygon(points = [[-52000, 3500], [-52000, 8500], [-32000, 8500], [-32000, 3500]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.8500000000, 0.8500000000, 0.6000000000]) {
				translate(v = [0, 0, 0.2200000000]) {
			...
			color(alpha = 1.0000000000, c = [0.8500000000, 0.8500000000, 0.6000000000]) {
				translate(v = [0, 0, 1.2200000000]) {
					linear_extrude(height = 2.0000000000) {
						polygon(points = [[-28000, -7000], [-28000, 7000], [58000, 7000], [58000, -7000]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.9000000000, 0.7000000000, 0.7000000000]) {
				translate(v = [0, 0, 0.2200000000]) {
					linear_extrude(height = 0.2000000000) {
						polygon(points = [[-5000, -5000], [-5000, 5000], [5000, 5000], [5000, -5000]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.9000000000, 0.7000000000, 0.7000000000]) {
				translate(v = [0, 0, 3.2200000000]) {
					linear_extrude(height = 0.5000000000) {
						difference() {
							polygon(points = [[-12000, -6000], [-12000, -500], [-27000, -500], [-27000, 500], [-12000, 500], [-12000, 6000], [12000, 6000], [12000, 1750], [19000, 1750], [19000, 1250], [12000, 1250], [12000, 750], [19000, 750], [19000, 500], [26000, 500], [26000, 6000], [50000, 6000], [50000, 1750], [57000, 1750], [57000, 1250], [50000, 1250], [50000, 750], [57000, 750], [57000, 250], [50000, 250], [50000, -250], [57000, -250], [57000, -750], [50000, -750], [50000, -1250], [57000, -1250], [57000, -1750], [50000, -1750], [50000, -6000], [26000, -6000], [26000, -500], [19000, -500], [19000, -750], [12000, -750], [12000, -1250], [19000, -1250], [19000, -1750], [12000, -1750], [12000, -6000]]);
							polygon(points = [[-5250, -1250], [-2750, -1250], [-2750, 1250], [-5250, 1250]]);
							polygon(points = [[2750, -1250], [5250, -1250], [5250, 1250], [2750, 1250]]);
							polygon(points = [[32750, -1250], [35250, -1250], [35250, 1250], [32750, 1250]]);
							polygon(points = [[40750, -1250], [43250, -1250], [43250, 1250], [40750, 1250]]);
						}
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.9000000000, 0.7000000000, 0.7000000000]) {
				translate(v = [0, 0, 3.2200000000]) {
					linear_extrude(height = 0.5000000000) {
						polygon(points = [[-5500, -5500], [-5500, 5500], [5500, 5500], [5500, -5500]]);
					}
				}
			}
			color(alpha = 1.0000000000, c = [0.7500000000, 0.7500000000, 0.7800000000]) {
				translate(v = [0, 0, 3.7200000000]) {
					linear_extrude(height = 0.5000000000) {
						polygon(points = [[-2500, -2500], [-2500, 2500], [2500, 2500], [2500, -2500]]);
					}
				}
			}
		}
